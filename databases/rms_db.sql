...
CREATE TABLE IF NOT EXISTS public.restuarent_order
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    quantity smallint NOT NULL,
    product_id_id bigint NOT NULL,
    staff_id_id bigint NOT NULL,
    CONSTRAINT restuarent_order_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS public.restuarent_product
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    product_name character varying(255) COLLATE pg_catalog."default" NOT NULL,
    product_cost integer NOT NULL,
    created_at timestamp with time zone NOT NULL,
    CONSTRAINT restuarent_product_pkey PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS public.restuarent_staff
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    name character varying(255) COLLATE pg_catalog."default" NOT NULL,
    email character varying(254) COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT restuarent_staff_pkey PRIMARY KEY (id),
    CONSTRAINT restuarent_staff_email_key UNIQUE (email)
);

CREATE TABLE IF NOT EXISTS public.restuarent_transaction
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    total_price integer NOT NULL,
    payment_status character varying(1) COLLATE pg_catalog."default" NOT NULL,
    date timestamp with time zone NOT NULL,
    order_id_id bigint NOT NULL,
    staff_id_id bigint NOT NULL,
    CONSTRAINT restuarent_transaction_pkey PRIMARY KEY (id)
);
...
ALTER TABLE IF EXISTS public.restuarent_order
    ADD CONSTRAINT restuarent_order_product_id_id_1c2f4e28_fk_restuaren FOREIGN KEY (product_id_id)
    REFERENCES public.restuarent_product (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX IF NOT EXISTS restuarent_order_product_id_id_1c2f4e28
    ON public.restuarent_order(product_id_id);


ALTER TABLE IF EXISTS public.restuarent_order
    ADD CONSTRAINT restuarent_order_staff_id_id_aabbf626_fk_restuarent_staff_id FOREIGN KEY (staff_id_id)
    REFERENCES public.restuarent_staff (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX IF NOT EXISTS restuarent_order_staff_id_id_aabbf626
    ON public.restuarent_order(staff_id_id);


ALTER TABLE IF EXISTS public.restuarent_transaction
    ADD CONSTRAINT restuarent_transacti_order_id_id_b9f04a72_fk_restuaren FOREIGN KEY (order_id_id)
    REFERENCES public.restuarent_order (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX IF NOT EXISTS restuarent_transaction_order_id_id_b9f04a72
    ON public.restuarent_transaction(order_id_id);


ALTER TABLE IF EXISTS public.restuarent_transaction
    ADD CONSTRAINT restuarent_transacti_staff_id_id_4d223a21_fk_restuaren FOREIGN KEY (staff_id_id)
    REFERENCES public.restuarent_staff (id) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION
    DEFERRABLE INITIALLY DEFERRED;
CREATE INDEX IF NOT EXISTS restuarent_transaction_staff_id_id_4d223a21
    ON public.restuarent_transaction(staff_id_id);
